    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6 md:py-8">
        ...
        <div className="mb-6 md:mb-8">
          <h2 className="text-2xl md:text-3xl font-serif font-bold text-foreground mb-4 md:mb-6">Nossos Produtos</h2>
            ...
            <Card key={produto.id} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-0">
                ...
                <div className="p-3 md:p-4">
                  ...
                  <p className="text-muted-foreground text-xs md:text-sm mb-3 line-clamp-2">{produto.descricao}</p>
        ...
        {/* Call to Action */}
        <div className="mt-12 md:mt-16 text-center bg-muted rounded-lg p-6 md:p-8">
